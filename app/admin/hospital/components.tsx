import { Plus, X, MapPin, Clock, Building } from 'lucide-react';
import { HospitalDataRequest, BasicInfoSectionProps, LocationSectionProps, ArraySectionProps, HoursSectionProps } from '../hospital/create/types';
import { useState } from 'react';

export const BasicInfoSection: React.FC<BasicInfoSectionProps> = ({ formData, setFormData, errors }) => (
...
export const LocationSection: React.FC<LocationSectionProps> = ({ formData, setFormData, errors }) => (
    <div className="space-y-4">
        <h2 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
...
export const ArraySection: React.FC<ArraySectionProps> = ({ title, icon, items, onItemsChange, placeholder, error }) => {
...
export const HoursSection: React.FC<HoursSectionProps> = ({ formData, setFormData }) => {
